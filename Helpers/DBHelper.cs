...
namespace WebAPICode.Helpers
{
    ...
    {
        private static readonly string connectionString = "data source=sql8003.site4now.net;initial catalog=db_aae5ab_adabfest;persist security info=True;user id=db_aae5ab_adabfest_admin;password=Tech@123;";
